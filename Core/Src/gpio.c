...
//typedef unsigned char my_unit8_t;
#define user_Button_mask (0x01 <<0)

uint8_t gpio_check_button(){
  uint32_t data= LL_GPIO_ReadInputPort(BTN_GPIO_Port);
  return (data & user_Button_mask);
}
/* USER CODE END 2 */
